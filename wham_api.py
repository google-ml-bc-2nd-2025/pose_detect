...
#from wham.models.smplify import TemporalSMPLify
from wham.models import build_network, build_body_model
from wham.utils.transforms import matrix_to_axis_angle
...
class WHAM_API(object):
    def __init__(self):
        ...
        self.network.eval()
        self.detector = DetectionModel(self.cfg.DEVICE.lower(), self.cfg.MMPOSE_CFG)
        self.extractor = FeatureExtractor(self.cfg.FEATURES_EXTR_CKPT, self.cfg.DEVICE.lower())
        self.slam = None
