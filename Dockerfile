...
RUN pip install --no-index --no-cache-dir pytorch3d -f https://dl.fbaipublicfiles.com/pytorch3d/packaging/wheels/py312_cu124_pyt260/download.html

RUN MMCV_WITH_OPS=1 pip install mmcv==2.1.0 -f https://download.openmmlab.com/mmcv/dist/cu124/torch2.6.0/index.html
RUN pip install mmdet~=3.3.0 mmpose~=1.3.0 mmengine==0.8.3 mmpretrain

RUN pip install https://data.pyg.org/whl/torch-2.0.0%2Bcu124/torch_scatter-2.1.2%2Bpt20cu124-cp312-cp312-linux_x86_64.whl
